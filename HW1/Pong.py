...
class Args:
    ...
    wandb_project_name: str = "Homework_2"
...
if __name__ == "__main__":
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step in [5_000, 100_000, 500_000, 1_000_000, 3_000_000, 5_000_000, 8_000_000]:
            model_path = f"runs/{run_name}/{args.exp_name}_{global_step}.tar"
            torch.save(q_network.state_dict(), model_path)

    if args.save_model:
        model_path = f"runs/{run_name}/{args.exp_name}.tar"
        torch.save(q_network.state_dict(), model_path)
